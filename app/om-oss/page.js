    ...
    <main style={{ background: "#0f1117", minHeight: "100vh", color: "#f9fafb", fontFamily: "'Inter', 'Poppins', sans-serif" }}>
      ...
      <section style={{ background: "linear-gradient(160deg,#0f1117 0%,#1a2035 100%)", padding: "5rem 2rem 4rem", borderBottom: "1px solid #1e2539" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <p style={{ margin: "0 0 0.5rem", fontSize: "0.72rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.15em", color: "#6b7280" }}>Om oss</p>
          ...
          <p style={{ margin: 0, fontSize: "1.1rem", color: "#9ca3af", lineHeight: 1.75, maxWidth: 600 }}>
      ...
      <section style={{ padding: "4rem 2rem", borderBottom: "1px solid #1e2539" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(260px,1fr))", gap: "1.5rem" }}>
          {[
            ...
            <div key={title} style={{ background: "#111827", border: "1px solid #1e2539", borderRadius: 4, padding: "1.5rem 1.75rem" }}>
              <h3 style={{ margin: "0 0 0.75rem", fontSize: "1rem", fontWeight: 800, color: "#f9fafb", letterSpacing: "-0.02em" }}>{title}</h3>
              <p style={{ margin: 0, fontSize: "0.92rem", color: "#9ca3af", lineHeight: 1.7 }}>{body}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{ padding: "4rem 2rem", borderBottom: "1px solid #1e2539" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <p style={{ margin: "0 0 0.5rem", fontSize: "0.72rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.15em", color: "#6b7280" }}>Teamet</p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))", gap: "1.25rem" }}>
            {[
              ...
              <div key={name} style={{ background: "#111827", border: "1px solid #1e2539", borderRadius: 4, padding: "1.5rem", textAlign: "center" }}>
                <div style={{ width: 56, height: 56, borderRadius: "50%", background: "#1a2035", border: "2px solid #252d40", margin: "0 auto 1rem", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.4rem", fontWeight: 800, color: "#4f6ef7" }}>
                  {name[0]}
                </div>
                <div style={{ fontWeight: 800, fontSize: "0.95rem", color: "#f9fafb", marginBottom: "0.25rem" }}>{name}</div>
      ...
      <section style={{ padding: "4rem 2rem" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <p style={{ margin: "0 0 0.5rem", fontSize: "0.72rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.15em", color: "#6b7280" }}>Tall</p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(160px,1fr))", gap: "1.25rem" }}>
            {[
              ...
              <div key={label} style={{ background: "#111827", border: "1px solid #1e2539", borderRadius: 4, padding: "1.5rem", textAlign: "center" }}>
                <div style={{ fontSize: "2rem", fontWeight: 900, color: "#f9fafb", letterSpacing: "-0.04em", marginBottom: "0.35rem" }}>{value}</div>
                <div style={{ fontSize: "0.8rem", color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.08em", fontWeight: 600 }}>{label}</div>
              </div>
            ))}
          </div>
        </div>
